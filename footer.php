<footer class="footer ftco-section">
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-lg-4 mb-4 mb-md-0">
						<h2 class="footer-heading">ADARSH BEROJGAR SEVA</h2>
						<p>The Adarsh Unemployed Seva Co-operative Society Ltd. was established by the Skill Development Department and Cooperative Department of the Maharashtra Government to offer employment opportunities to youth by providing various services.</p>
					</div>
					<div class="col-md-4 col-lg-4 mb-4 mb-md-0">
  ...
  <!-- Include jQuery datetimepicker CSS and JS -->
